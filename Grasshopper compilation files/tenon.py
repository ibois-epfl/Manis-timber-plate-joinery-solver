...
class MyComponent(component):
    ...
    def RegisterInputParams(self, pManager):
        ...
        p = Grasshopper.Kernel.Parameters.Param_Number()
        self.SetUpParam(p, "tenon_space", "tenon_space", "The space between two tenons.")
        p.Access = Grasshopper.Kernel.GH_ParamAccess.item
        self.Params.Input.Add(p)
        ...
        p = Grasshopper.Kernel.Parameters.Param_Number()
        self.SetUpParam(p, "tenon_angle", "tenon_angle", "(Optional) Change the direction of the tenon in the plane of the plate.")
        p.Access = Grasshopper.Kernel.GH_ParamAccess.item
        self.Params.Input.Add(p)
    ...
    def RunScript(self, model, plates_pairs, tenon_number, tenon_length, tenon_width, tenon_space, tenon_shift, tenon_angle):
