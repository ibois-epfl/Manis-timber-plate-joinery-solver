...
class MyComponent(component):
    ...
    def RegisterInputParams(self, pManager):
        ...
        p = Grasshopper.Kernel.Parameters.Param_Number()
        self.SetUpParam(p, "finger_space", "finger_space", "The space between two fingers.")
        p.Access = Grasshopper.Kernel.GH_ParamAccess.item
        self.Params.Input.Add(p)
    ...
    def RunScript(self, model, plates_pairs, finger_number_1, finger_length_1, finger_width_1, finger_number_2, finger_length_2, finger_width_2, finger_space, finger_shift, mirror):
