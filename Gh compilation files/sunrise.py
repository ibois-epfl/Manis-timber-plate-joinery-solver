"""Create Sunrise dovetail joints for edgewise connections."""
...
class MyComponent(component):
    ...
    def RegisterInputParams(self, pManager):
        ...
        self.SetUpParam(p, "parallel_tenons", "parallel_tenons", "If true the lateral faces of each tenon will be parallel.")
        p.Access = Grasshopper.Kernel.GH_ParamAccess.item
        self.Params.Input.Add(p)
        
        p = Grasshopper.Kernel.Parameters.Param_Vector()
        self.SetUpParam(p, "custom_insertion", "custom_insertion", "Optional vector of insertion to force assembly in one specific direction.")
        p.Access = Grasshopper.Kernel.GH_ParamAccess.item
        self.Params.Input.Add(p)
    ...
    def RunScript(self, model, plates_pairs, tenon_number, tenon_width, tenon_spacing, tenon_shift, spread_angle, parallel_tenons, custom_insertion):
