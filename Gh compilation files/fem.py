"""Get the mid-surface of each plate and the joints of the model as line segments."""
...
class MyComponent(component):
    def __new__(cls):
        instance = Grasshopper.Kernel.GH_Component.__new__(cls,
            "FEM data", "FEM data", """Get the mid-surface of each plate and the joints of the model as line segments.""", "Manis", "FEM")
        return instance
